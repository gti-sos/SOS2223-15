...
app.put('/api/v1/loss-jobs/:province', (req, res) => {
  ...
  if (filteredList.length === 0 || province !== provincebody) {
    ...
    /*for (let i = 0; i < filteredList.length; i++) {
      ...
      stat.year = req.body.year || stat.year;
      stat.gender = req.body.gender || stat.gender;
      stat.man = req.body.man || stat.man;
      stat.low_due_to_placement = req.body.low_due_to_placement || stat.low_due_to_placement;
      stat.no_renovation = req.body.no_renovation || stat.no_renovation;
      stat.other_reason = req.body.other_reason || stat.other_reason;
